...
def tarea(tablero):
    ...
    if conectar==True:
        ...
        de="    Al presionar     --->" 
        para="   Enviados      --->"
        msg="Se mostrarán los mensajes enviados."
        whatsintro_gui.agregar_mensaje_al_final(de, para, msg)
        de="    Al presionar     --->"
        para="   Recibidos     --->"
        msg="Se mostrarán los mensajes recibidos."
        whatsintro_gui.agregar_mensaje_al_final(de, para, msg)
        de=" "
        para=" "
        msg=" "
        ...
        de=" "
        para=" "
        msg="Presione cualquier botón para comenzar..."
        whatsintro_gui.agregar_mensaje_al_final(de, para, msg)
    ...
    while conectar==True:
        ...
        while VF==1:
            ...
            if click=='enviados':
                ...
                mensaje_en_cuadro=str(whatsintro_gui.mensaje_redactado())

                print(mensaje_en_cuadro)
                if (mensaje_en_cuadro)=="mostrar todo":
                    for k in range(0, 98, 3):
                        if whatsintro_msg.mensaje_enviado(k)!=whatsintro_msg.mensaje_enviado(k+1):
                            ...
                            contad+=1
                            print(contad)
                            print(int(whatsintro_msg.cantidad_recibidos()))
                ...
                for k in range(110, int(cantidad_enviados),2):
                    if whatsintro_msg.mensaje_enviado(k)!=whatsintro_msg.mensaje_enviado(k+1):
                        texto_enviado=(whatsintro_msg.mensaje_enviado(k))
            ...
            if click=='recibidos':
                ...
                for k in range(0, int(cantidad_recibidos), 3):
