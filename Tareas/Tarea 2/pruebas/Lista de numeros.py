        ...
        while VF==1:
            ...
            if click=='recibidos':
                ...
                for k in range(0, int(cantidad_recibidos)):
                    #EL MENSAJE 25 PRESENTA UN ERROR Y NO ME PERMITE CARGAR LOS SIGUIENTES, POR LO TANTO HAGO UNA EXCEPCION CON EL Y NO LO CARGO
                    #DEBERIA SER UN ERROR DE QUIEN LO ENVIO
                    #EN CASO DE BORRAR LOS MENSAJES DEL SERVIDOR...
                    #...PARA VER LA TOTALIDAD DE LOS MENSAJES SE ARREGLA BORRANDO...
                    #...EL if k!=25 Y DESDENTANDO LAS FILAS INFERIORES CORRESPONDIENTES.
                    if k!=25:
