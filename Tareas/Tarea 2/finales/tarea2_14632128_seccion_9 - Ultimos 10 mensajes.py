...
def tarea(tablero):
    ...
    if conectar==True:
        ...
        de="    Al presionar     --->" 
        para="   Enviados      --->"
        msg="Se mostraran los ultimos 10 mensajes enviados."
        whatsintro_gui.agregar_mensaje_al_final(de, para, msg)
        de="    Al presionar     --->"
        para="   Recibidos     --->"
        msg="Se mostraran los ultimos 10 mensajes recibidos."
        whatsintro_gui.agregar_mensaje_al_final(de, para, msg)
        de=" "
        para=" "
        msg=" "
    ...
    while conectar==True:
        ...
        while VF==1:
            ...
            if click=='enviados':
                ...
                for k in range(int(cantidad_enviados)-10, int(cantidad_enviados)):
            ...
            if click=='recibidos':
                ...
                for k in range(int(cantidad_recibidos)-10, int(cantidad_recibidos)):
