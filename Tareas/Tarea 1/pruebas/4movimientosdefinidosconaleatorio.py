    ...
    while 1+1==2:
        ...
        while val==True:
            ...
            if tecla=='arriba':
                ...
                if (A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P)!=(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p):
                    al=True
                if al==True:
                    R=False
                    if (m,n,o,p)==(0,0,0,0):
                        aleatarriba = ["m","n","o","p"]
                        R=True
                    if m!=0 and (n,o,p)==(0,0,0):
                        aleatarriba = ["n","o","p"]
                        R=True
                    if n!=0 and (m,o,p)==(0,0,0):
                        aleatarriba = ["m","o","p"]
                        R=True
                    if o!=0 and (m,n,p)==(0,0,0):
                        aleatarriba = ["m","n","p"]
                        R=True
                    if p!=0 and (m,o,n)==(0,0,0):
                        aleatarriba = ["m","n","o"]
                        R=True
                    if (m,n)!=(0,0) and (o,p)==(0,0):
                        aleatarriba = ["o","p"]
                        R=True
                    if (o,p)!=(0,0) and (n,m)==(0,0):
                        aleatarriba = ["n","m"]
                        R=True
                    if (m,p)!=(0,0) and (o,n)==(0,0):
                        aleatarriba = ["o","n"]
                        R=True
                    if (o,n)!=(0,0) and (m,p)==(0,0):
                        aleatarriba = ["m","p"]
                        R=True
                    if (o,m)!=(0,0) and (n,p)==(0,0):
                        aleatarriba = ["n","p"]
                        R=True
                    if (p,n)!=(0,0) and (o,m)==(0,0):
                        aleatarriba = ["o","m"]
                        R=True
                        
                    if (m,n,o)!=(0,0,0) and p==0:
                        p=aleatorio()
                    if (m,n,p)!=(0,0,0) and o==0:
                        o=aleatorio()
                    if (p,n,o)!=(0,0,0) and m==0:
                        m=aleatorio()
                    if (m,p,o)!=(0,0,0) and n==0:
                        n=aleatorio()
