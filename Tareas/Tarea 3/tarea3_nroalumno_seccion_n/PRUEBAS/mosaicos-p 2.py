...
def escala_grises(matriz):
    ...
    for i in range(n_filas):
        for j in range(n_columnas):
            promedioRGB=int((int(aux[i][j][0])+int(aux[i][j][1])+int(aux[i][j][2]))/3)
...
def diferencia_pixeles(porcion,mosaico):
    suma=0
    for f in range(5):
        for c in range(5):
            suma+=diferencia_colores(porcion[f][c],mosaico[f][c])
    return (suma)
...
def imagen_mosaico(matriz_original, lista_mosaicos):
    n_mosaicos=len(lista_mosaicos)
    nueva_imagen=copy.deepcopy(matriz_original)
    #iterando imagenes mosaico
    for i in range(n_mosaicos):
        #iterando filas de cada mosaico
        for j in range(5):
            #iterando elementos de las filas (columnas)
            for k in range(5):
                pass

def division_porciones(original):
    partida=copy.deepcopy(original)
    n_filas=len(original)
    n_columnas=len(original[0])
    #cantidad de particiones sera igual a int((len(original)/5)
    n_porciones=int((len(original)/5))
    nueva=[]
    for k in range(n_porciones):
        for i in range(n_filas):
            nueva_fila=[]
            for j in range(n_columnas):
                nuevo_efila=partida[i][j]
                nueva_fila.append(nuevo_efila)
...
original=[[(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3)],[(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3)],[(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3)],[(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3)],[(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3)],[(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3)],[(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3)],[(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3)],[(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3)],[(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3),(1,2,3)]]

print(len(original))

print(division_porciones(original))
